...
public class ExampleJob9 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        env.fromSource(eventsSource,
                        WatermarkStrategy.<Event>forBoundedOutOfOrderness(Duration.ofMinutes(1)).withTimestampAssigner((e, ts) -> e.getTimestamp()),
                    "events"
                )
                .name("Source events")
                .uid("source-events")
                ...
                .keyBy(Event::getUid)
                .process(new UniqueCounterWithTimerFunction())
                .name("Count events")
                .uid("count-events")
